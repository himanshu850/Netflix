// api key from TMDB
const api = "ed5b31c048c28cfdf5af44d7603ddf2c";
//base url for the site
const base_url = "https://api.themoviedb.org/3";
//url
const final_url= base_url + "/discover/movie?api_key=" + api + "&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1";
//image url
const img_url = "https://image.tmdb.org/t/p/original/";

//requests for the movies
const requests = {
    fetchPopular: `${base_url}/discover/movie?api_key=${api}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1`,
    ...
    //fetchTopRated: `${base_url}/movie/top_rated?api_key=${api}&language=en-US`,
